                    ...
                    while($fila = mysqli_fetch_array($paquetes)){ ?>
                            <tr class="align-middle">
                                ...
                                <td><?php echo $fila['fecha_entrega']?></td>
                                 ...
                                 <a href="../CONTROLADOR/editPaquetes.php?id_paquete=<?php echo $fila['id_paquete']; ?>" class="btn btn-small btn-warning"><i class="fas fa-pen-nib"></i></a>
                                 <a href="../CONTROLADOR/deleteCruds.php?id_paquete=<?php echo $fila['id_paquete']; ?>" class="btn btn-small btn-danger"><i class="fas fa-trash"></i></a>    
                                </td>
                            </tr>
                    <?php } ?>
                </tbody>
