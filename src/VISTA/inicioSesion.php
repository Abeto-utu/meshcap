          ...
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <label class="form-label" for="typeEmailX">N° Funcionario</label>
                <input type="number" id="typeEmailX" class="form-control form-control-lg" name="numero_funcionario"/>
              </div>

              <div class="form-outline form-white mb-4">
              <label class="form-label" for="typePasswordX">Contraseña</label>
                <input type="password" id="typePasswordX" class="form-control form-control-lg" name="clave" maxlength="16" minlength="6"/>
              </div>
              ...
              <div class="d-flex justify-content-center text-center mt-4 pt-1">
                ...
                <a href="https://www.google.com/intl/es/gmail/about" class="text-white"><i class="fab fa-google fa-lg m-3"></i></a>
              </div>
