...
<?php require_once('../CONTROLADOR/ControladorPaquetes.php'); ?>
...
<body>
  ...
  <nav class="navbar navbar-dark bg-dark p-4 ">
    ...
    <div class="container-fluid row" $id="container-total">
      <form action="../CONTROLADOR/ControladorPaquetes.php" method="POST" class="col-3 p-5 m-3 bg-dark text-light">
        <div class="mb-3">
          <h3 class ="text-light text-center">Registro Paquetes</h3>
            ...
            <label for="exampleInputEmail1" class="form-label">Plataforma Actual:</label>
              <select class="form-select mb-3" aria-label="Default select example" name="plataforma_actual_paquete" required>
                <option value="Artigas">Artigas</option>
                <option value="Canelones">Canelones</option>
                <option value="Cerro Largo">Cerro Largo</option>
                <option value="Colonia">Colonia</option>
            ...
            <label for="exampleInputEmail1" class="form-label">Estado del Paquete</label>
              <select class="form-select mb-3" aria-label="Default select example" name="estado_paquete" required>
                ...
                <tbody>
                    ...
                    foreach ($paquetes as $paquete): ?>
                        <tr class="align-middle">
                            ...
                            <td></td>
                            <td><?= $paquete['fecha_recibo']?></td>
                            <td><?= $paquete['fecha_entrega']?></td>
                            <td class="align-middle">
                                <a href="../CONTROLADOR/ControladorPaquetes.php?editar_paquete=<?= $paquete['id_paquete'] ?>" class="btn btn-small btn-warning"><i class="fas fa-pen-nib"></i></a>
                                <a href="../CONTROLADOR/ControladorPaquetes.php?eliminar_paquete=<?= $paquete['id_paquete'] ?>" class="btn btn-small btn-danger"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
