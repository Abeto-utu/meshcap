    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <form action="../CONTROLADOR/controladorAlmacenero.php?entregarPaquete=entregarPaquete" method="POST">
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label"
                            data-i18n="identifier">Identificador:</label>
                    ...
                    <div class="container mt-3"><button type="submit" class="btn btn-secondary"
                            data-i18n="deliver">Entregar</button></a>
                    </div>
                </form>
                <div class="mb-5"></div>
            </div>
