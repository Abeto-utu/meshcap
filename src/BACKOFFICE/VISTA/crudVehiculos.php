...
<nav class="navbar navbar-dark bg-dark p-4 ">
    <div class="container-fluid">
      <a class="navbar-brand" href="../../HOMEPAGE/VISTA/index.html" id="logo"><img src="../../IMAGES/gorraBlanca.png" height="40" alt="">MeshCap</a>
                    ...
                    while($fila = mysqli_fetch_array($vehiculo)){ ?>
                            <tr class="align-middle">
                                ...
                                <td><?php echo $fila['tipo']?></td>
                                 ...
                                 <a href="../VISTA/editVehiculos.php?matricula=<?php echo $fila['matricula']; ?>" class="btn btn-small btn-warning"><i class="fas fa-pen-nib"></i></a>
