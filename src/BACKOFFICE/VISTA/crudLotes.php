...
<body>
  ...
  <nav class="navbar navbar-dark bg-dark p-4 ">
    <div class="container-fluid">
      <a class="navbar-brand" href="backoffice.html" id="logo"><img src="../../IMAGES/gorraBlanca.png"
        ...
        <tbody>
          ...
          while ($fila = mysqli_fetch_array($lote)) { ?>
            <tr class="align-middle">
              ...
              <td></td>
              <td>
                <a href="../VISTA/editLotes.php?id_lote=<?php echo $fila['id_lote']; ?>"
                  class="btn btn-small btn-warning"><i class="fas fa-pen-nib"></i></a>
                <a href="../CONTROLADOR/deleteCruds.php?id_lote=<?php echo $fila['id_lote']; ?>"
